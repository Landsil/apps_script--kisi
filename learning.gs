 ...
 * "Current web app URL:" === Webhook link in Kisi integration
 * eg. link: https://script.google.com/macros/s/i34etgh8iydufg8iheysgfhdieyr/exec
 */
 
//this is a Function that starts when the webapp receives a POST request from Kisi
// Read data here
function onPOST(e) {
...
// Obwious down side of this script is that preety fast spreadsheet will be to big to open in a resonable manner.
